...
export default hopeTheme({
  ...
  blog: {
    medias: {
      ...
      GQBlog: [
        "http://zgq.cool",
        '<svg viewBox="0 0 1000 1000" xmlns="http://docs.zgq.cool/vite.svg">' +
        '<defs>' +
        '<linearGradient gradientTransform="matrix(.2478 .78133 -2.54797 .63622 910.35 281.58)" gradientUnits="userSpaceOnUse" id="a" x1="37.827" x2="159.988" y1="272.916" y2="274.63"><stop offset=".75" stop-color="#e33939"/><stop offset=".998" stop-color="#fff"/>' +
        '</linearGradient>' +
        '<linearGradient gradientTransform="matrix(.13814 .80797 2.55599 -.6032 34.087 494.369)" gradientUnits="userSpaceOnUse" id="b" x1="37.827" x2="159.988" y1="272.916" y2="274.63"><stop offset=".815" stop-color="#e33939"/><stop offset="1" stop-color="#fff"/>' +
        '</linearGradient>' +
        '</defs>' +
